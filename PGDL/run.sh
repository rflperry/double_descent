...
python ingestion_program/ingestion.py /mnt/ssd3/ronan/double_descent/phase_two_data/input_data/ private_complexities ingestion_program sample_code_submission task7
